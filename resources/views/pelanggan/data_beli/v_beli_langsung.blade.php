...
@section('content')
    <main class="product-section">
        <div class="container-product">
            <h3 class="text-title">Pembelian Langsung</h3>

            <!-- Form Pembelian Langsung -->
            <form action="{{ route('pelanggan_data.saveBeliLangsung') }}" method="POST" id="beli-langsung-form"
                                ...
                                <tr>
                                    <td>
                                        @if (!empty($item['foto_produk']))
                                            <img src="{{ asset('fotoproduk/' . $item['foto_produk']) }}"
                                    ...
                                    <td>Rp. {{ number_format($item['harga_produk'] ?? 0, 0, ',', '.') }}
                                        <input type="hidden" name="harga_produk" value="{{ $item['harga_produk'] }}">
                                    </td>
                                    <td>Rp.
                                        {{ number_format(($item['harga_produk'] ?? 0) * ($item['jumlah_produk'] ?? 0), 0, ',', '.') }}
                                    </td>
                ...
                <!-- Peta -->
                <div id="map_pusat" style="height: 400px; width: 100%;" class="mb-3"></div>
                ...
                <!-- A.N Rekening -->
                <div class="form-group profile">
                    <label for="a_n" class="form-label">Atas Nama</label>
                    <input type="text" id="a_n" name="a_n" class="form-control" value="" readonly>
                </div>

                <!-- No Rekening -->
                <div class="form-group profile">
                    <label for="no_rek" class="form-label">Nomor Rekening</label>
                    <input type="text" id="no_rek" name="no_rek" class="form-control" value="" readonly>
                </div>
    ...
    <script>
        ...
        // Kode Transaksi (generate berdasarkan produk)
        (function() {

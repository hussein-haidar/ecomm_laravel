        ...
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <!-- Form Update -->
                    <form action="{{ route('superadmin_data.update_website', $website->id_website) }}" method="POST"
                            ...
                            <select id="id_promo" name="id_promo" class="form-control">
                                ...
                                @foreach ($data_promo as $promo)
                                    <option value="{{ $promo->id_promo }}"
                                        {{ old('id_promo', $website->id_promo ?? '') == $promo->id_promo ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            <label>Nomor Telepon Platofrom</label>

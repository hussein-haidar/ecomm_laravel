        ...
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <!-- Form Open -->
                    <form action="{{ route('superadmin_data.save_website') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_toko" class="form-control" placeholder="Masukkan Nama Platform" required>
                        </div>

                        <div class="form-group">
                            <label for="id_promo">Event Promo</label>
                            <select id="id_promo" name="id_promo" class="form-control">
                                <option value="">Pilih Promo</option>
                                @foreach ($data_promo as $promo)
                                    <option value="{{ $promo->id_promo }}">
                                        {{ $promo->nama_promo }} (ID: {{ $promo->id_promo }})
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <!-- Lokasi Toko Pusat -->
                        <label><strong>Pilih Lokasi Platform</strong></label>
                        ...
                        <div class="form-group">
                            <label for="longitude_pusat">Longitude Platform:</label>
                        ...
                        <div class="form-group">
                            ...
                            <input name="alamat_pusat" class="form-control" placeholder="Masukkan Alamat Platform" required>
                        </div>

                        <div class="form-group">
                            <label>Nomor Telepon Platform</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ route('superadmin_data.website') }}" class="btn btn-primary">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>

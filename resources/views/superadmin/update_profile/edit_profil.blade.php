...
<form action="{{ url('superadmin_data/update_profile/' . $profil['id_user']) }}" method="POST" enctype="multipart/form-data">  
    @csrf   
          ...
          <div class="form-group">  
            ...
            <div class="form-group">  
                ...
                <div class="modal-footer">
                 ...
                 <a href="{{ route('superadmin_data.profil') }}" class="btn btn-primary">Kembali</a>  
                </div>

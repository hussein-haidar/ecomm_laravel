...
@section('content') 
        ...
        <div class="box">
            <div class="box-header">
               <td> <a href="{{ route('pemilik_data.add_satuan') }}" class="btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>
        Tambah Data</a></td>
            </div>
...
@endif
    ...
    <a href="{{ route('pemilik_data.edit_satuan', $value->id_satuan) }}" class="btn btn-xs btn-warning"><i class="fa fa-fw fa-edit"></i>Edit</a>
              <!-- Link untuk Delete satuan -->  
                <button class="btn btn-danger btn-sm btn-xs" data-toggle="modal" data-target="#delete<?= $value['id_satuan'] ?>"><i class="fa fa-fw fa-trash"></i>Delete</button>
              </td>
            </tr>
          <?php } ?>
        </tbody>

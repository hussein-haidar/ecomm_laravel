                ...
                <div class="box-body">
                    ...
                    <center>
                        <div class="form-group">
                            ...
                            <p></p>
                            <img src="{{ asset('fotouser/' . session('foto_user')) }}" class="img-circle" id="gambar_load"
                    ...
                    <div class="form-group">
                        ...
                        <input name="password" type="password" id="ShowPass" value="{{ session('password') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="level"
                            value="{{ session('level') == 'pemilik' ? 'Pemilik' : (session('level') == 'admin' ? 'Admin' : '') }}"
                            class="form-control" readonly>
                    </div>
                    ...
                    <div>
                        @if (!empty($profil) && isset($profil->id_user))
                            <a href="{{ route('admin_data.edit', ['id_user' => $profil->id_user]) }}"
                                class="btn btn-warning">
                                <i class="fa fa-fw fa-edit"></i> Edit Profil
                            </a>
                        @else
                            <p class="text-danger">Data profil tidak tersedia.</p>
                        @endif

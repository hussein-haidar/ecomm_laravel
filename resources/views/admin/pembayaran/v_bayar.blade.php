    ...
    <div class="box-body">
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <img src="{{ asset('fotobayar/' . $value->foto_bayar) }}" class="img-circle" width="80px"
                            height="80px">
                        <a href="{{ route('admin_data.viewFoto', $value->id_bayar) }}">Lihat Foto</a>
                    </td>
                    <td>
                        <form method="POST" action="{{ route('admin_data.konfirmStatusBayar') }}" class="d-inline">
                            @csrf
                            @method('POST')
                            ...
                            <select name="status_bayar" class="form-control d-inline w-auto"
                                ...
                                @else
                                    background-color: #f0ad4e; color: white; @endif>
                                ...
                                <option value="Dibayar" {{ $value->status_bayar == 'Dibayar' ? 'selected' : '' }}>
                                    Dibayar</option>
                            </select>

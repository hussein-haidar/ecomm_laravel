...
<div class="box">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a href="{{ route('admin_data.view_retur') }}" class="btn btn-default btn-sm">
            ...
            <div class="col-md-5">
                @if($retur->status == 'Menunggu Verifikasi')
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <form method="POST" action="{{ route('admin_data.verifikasi_retur', $retur->id_retur) }}">
                                @csrf
                ...
                @elseif($retur->status == 'Barang Dalam Perjalanan')
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <form method="POST" action="{{ route('admin_data.terima_retur', $retur->id_retur) }}">
                                @csrf
                ...
                @elseif(in_array($retur->status, ['Barang Diterima', 'Selesai']))
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <form method="POST" action="{{ route('admin_data.selesaikan_retur', $retur->id_retur) }}">
                                @csrf

...
@section('content')
    @if (Session::has('pesan_welcome'))
        <div class="alert alert-success" role="alert">
            {{ Session::get('pesan_welcome') }}
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-yellow">
                <div class="inner">
                    <h3>{{ count($tot_stok) }}</h3>
                    <p>Jenis Stok Produk</p>
                </div>
                <div class="icon"><i class="ion ion-stats-bars"></i></div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-red">
                <div class="inner">
                    <h3>Rp. {{ number_format($tot_harga_stok, 0, ',', '.') }}</h3>
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-green">
                <div class="inner">
                    <h3>{{ count($tot_pembayaran_selesai) }}</h3>
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-red">
                <div class="inner">
                    <h3>{{ count($tot_pembayaran_batal) }}</h3>

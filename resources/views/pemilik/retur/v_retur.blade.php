            ...
            <div class="col-md-6">
                <form method="GET" class="form-inline">
                    ...
                    @if(request('search') || request('status'))
                        <a href="{{ route('pemilik_data.view_retur') }}" class="btn btn-default ml-2">Reset</a>
                    @endif
                </form>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('pemilik_data.detail_retur', $value->id_retur) }}" class="btn btn-info btn-sm">

  ...
  @section('content')
      <div class="box">
          <div class="box-header">
              <td>
                  <a href="{{ route('pemilik_data.add_website') }}" class="btn-sm btn-primary">
                          ...
                          @foreach ($website as $key => $value)
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <td>
                                      <form method="POST" action="{{ route('pemilik_data.konfirmStatusWeb_By_Sesi') }}"
                                          class="d-inline">
                                          @csrf
                                  ...
                                  <td>
                                      ...
                                      <a href="{{ route('pemilik_data.edit_website', $value['id_website']) }}"
                                      ...
                                      <form id="delete-form-{{ $value['id_website'] }}"
                                          action="{{ route('pemilik_data.delete_website', $value['id_website']) }}"
